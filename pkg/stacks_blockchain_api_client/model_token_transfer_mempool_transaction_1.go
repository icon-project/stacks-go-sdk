...
// checks if the TokenTransferMempoolTransaction1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TokenTransferMempoolTransaction1{}

// TokenTransferMempoolTransaction1 struct for TokenTransferMempoolTransaction1
type TokenTransferMempoolTransaction1 struct {
	// Transaction ID
	...
	TokenTransfer TokenTransferTransactionTokenTransfer `json:"token_transfer"`
}

type _TokenTransferMempoolTransaction1 TokenTransferMempoolTransaction1
...
func NewTokenTransferMempoolTransaction1(txId string, nonce int32, feeRate string, senderAddress string, sponsored bool, postConditionMode TokenTransferTransactionPostConditionMode, postConditions []TokenTransferTransactionPostConditionsInner, anchorMode TokenTransferTransactionAnchorMode, txStatus TokenTransferMempoolTransaction1TxStatus, receiptTime int32, receiptTimeIso string, txType string, tokenTransfer TokenTransferTransactionTokenTransfer) *TokenTransferMempoolTransaction1 {
	this := TokenTransferMempoolTransaction1{}
	this.TxId = txId
	this.Nonce = nonce
...
func (o *TokenTransferMempoolTransaction1) GetTokenTransfer() TokenTransferTransactionTokenTransfer {
	if o == nil {
		var ret TokenTransferTransactionTokenTransfer
		return ret
	}
...
func (o TokenTransferMempoolTransaction1) MarshalJSON() ([]byte, error) {
...
func (o TokenTransferMempoolTransaction1) ToMap() (map[string]interface{}, error) {
...
func (o *TokenTransferMempoolTransaction1) UnmarshalJSON(data []byte) (err error) {
	...
	varTokenTransferMempoolTransaction1 := _TokenTransferMempoolTransaction1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTokenTransferMempoolTransaction1)

	if err != nil {
		return err
	}

	*o = TokenTransferMempoolTransaction1(varTokenTransferMempoolTransaction1)

	return err
}

type NullableTokenTransferMempoolTransaction1 struct {
	value *TokenTransferMempoolTransaction1
	isSet bool
}

func (v NullableTokenTransferMempoolTransaction1) Get() *TokenTransferMempoolTransaction1 {
	return v.value
}

func (v *NullableTokenTransferMempoolTransaction1) Set(val *TokenTransferMempoolTransaction1) {
	v.value = val
	v.isSet = true
}

func (v NullableTokenTransferMempoolTransaction1) IsSet() bool {
	return v.isSet
}

func (v *NullableTokenTransferMempoolTransaction1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTokenTransferMempoolTransaction1(val *TokenTransferMempoolTransaction1) *NullableTokenTransferMempoolTransaction1 {
	return &NullableTokenTransferMempoolTransaction1{value: val, isSet: true}
}

func (v NullableTokenTransferMempoolTransaction1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTokenTransferMempoolTransaction1) UnmarshalJSON(src []byte) error {
	v.isSet = true
