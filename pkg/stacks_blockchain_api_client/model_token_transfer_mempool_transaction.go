...
// checks if the TokenTransferMempoolTransaction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TokenTransferMempoolTransaction{}

// TokenTransferMempoolTransaction struct for TokenTransferMempoolTransaction
type TokenTransferMempoolTransaction struct {
	// Transaction ID
...
type _TokenTransferMempoolTransaction TokenTransferMempoolTransaction
...
func NewTokenTransferMempoolTransaction(txId string, nonce int32, feeRate string, senderAddress string, sponsored bool, postConditionMode TokenTransferTransaction1PostConditionMode, postConditions []TokenTransferTransaction1PostConditionsInner, anchorMode TokenTransferTransaction1AnchorMode, txStatus TokenTransferMempoolTransactionTxStatus, receiptTime int32, receiptTimeIso string, txType string, tokenTransfer TokenTransferTransactionTokenTransfer) *TokenTransferMempoolTransaction {
	this := TokenTransferMempoolTransaction{}
	this.TxId = txId
	this.Nonce = nonce
...
func (o TokenTransferMempoolTransaction) MarshalJSON() ([]byte, error) {
...
func (o TokenTransferMempoolTransaction) ToMap() (map[string]interface{}, error) {
...
func (o *TokenTransferMempoolTransaction) UnmarshalJSON(data []byte) (err error) {
	...
	varTokenTransferMempoolTransaction := _TokenTransferMempoolTransaction{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTokenTransferMempoolTransaction)

	if err != nil {
		return err
	}

	*o = TokenTransferMempoolTransaction(varTokenTransferMempoolTransaction)

	return err
}

type NullableTokenTransferMempoolTransaction struct {
	value *TokenTransferMempoolTransaction
	isSet bool
}

func (v NullableTokenTransferMempoolTransaction) Get() *TokenTransferMempoolTransaction {
	return v.value
}

func (v *NullableTokenTransferMempoolTransaction) Set(val *TokenTransferMempoolTransaction) {
	v.value = val
	v.isSet = true
}

func (v NullableTokenTransferMempoolTransaction) IsSet() bool {
	return v.isSet
}

func (v *NullableTokenTransferMempoolTransaction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTokenTransferMempoolTransaction(val *TokenTransferMempoolTransaction) *NullableTokenTransferMempoolTransaction {
	return &NullableTokenTransferMempoolTransaction{value: val, isSet: true}
}

func (v NullableTokenTransferMempoolTransaction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTokenTransferMempoolTransaction) UnmarshalJSON(src []byte) error {
	v.isSet = true
