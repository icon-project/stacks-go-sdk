...
func (r ApiGetMempoolFeePrioritiesRequest) Execute() (*GetMempoolFeePriorities200Response, *http.Response, error) {
...
//  @return GetMempoolFeePriorities200Response
func (a *MempoolAPIService) GetMempoolFeePrioritiesExecute(r ApiGetMempoolFeePrioritiesRequest) (*GetMempoolFeePriorities200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetMempoolFeePriorities200Response
	)
