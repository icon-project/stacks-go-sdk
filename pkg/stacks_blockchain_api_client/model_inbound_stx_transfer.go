...
var _ MappedNullable = &InboundStxTransfer{}

// InboundStxTransfer struct for InboundStxTransfer
type InboundStxTransfer struct {
	...
	TransferType InboundStxTransferTransferType `json:"transfer_type"`
...
func (o *InboundStxTransfer) GetTransferType() InboundStxTransferTransferType {
	if o == nil {
		var ret InboundStxTransferTransferType
		return ret
	}
