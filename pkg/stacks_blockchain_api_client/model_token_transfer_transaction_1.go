...
// checks if the TokenTransferTransaction1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TokenTransferTransaction1{}

// TokenTransferTransaction1 struct for TokenTransferTransaction1
type TokenTransferTransaction1 struct {
	// Transaction ID
...
type _TokenTransferTransaction1 TokenTransferTransaction1
...
func NewTokenTransferTransaction1(txId string, nonce int32, feeRate string, senderAddress string, sponsored bool, postConditionMode TokenTransferTransaction1PostConditionMode, postConditions []TokenTransferTransaction1PostConditionsInner, anchorMode TokenTransferTransaction1AnchorMode, blockHash string, blockHeight int32, blockTime float32, blockTimeIso string, burnBlockTime int32, burnBlockHeight int32, burnBlockTimeIso string, parentBurnBlockTime int32, parentBurnBlockTimeIso string, canonical bool, txIndex int32, txStatus TokenTransferTransaction1TxStatus, txResult TokenTransferTransactionTxResult, eventCount int32, parentBlockHash string, isUnanchored bool, microblockHash string, microblockSequence int32, microblockCanonical bool, executionCostReadCount int32, executionCostReadLength int32, executionCostRuntime int32, executionCostWriteCount int32, executionCostWriteLength int32, events []TokenTransferTransaction1EventsInner, txType string, tokenTransfer TokenTransferTransactionTokenTransfer) *TokenTransferTransaction1 {
	this := TokenTransferTransaction1{}
	this.TxId = txId
	this.Nonce = nonce
...
func (o TokenTransferTransaction1) MarshalJSON() ([]byte, error) {
...
func (o TokenTransferTransaction1) ToMap() (map[string]interface{}, error) {
...
func (o *TokenTransferTransaction1) UnmarshalJSON(data []byte) (err error) {
	...
	varTokenTransferTransaction1 := _TokenTransferTransaction1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTokenTransferTransaction1)

	if err != nil {
		return err
	}

	*o = TokenTransferTransaction1(varTokenTransferTransaction1)

	return err
}

type NullableTokenTransferTransaction1 struct {
	value *TokenTransferTransaction1
	isSet bool
}

func (v NullableTokenTransferTransaction1) Get() *TokenTransferTransaction1 {
	return v.value
}

func (v *NullableTokenTransferTransaction1) Set(val *TokenTransferTransaction1) {
	v.value = val
	v.isSet = true
}

func (v NullableTokenTransferTransaction1) IsSet() bool {
	return v.isSet
}

func (v *NullableTokenTransferTransaction1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTokenTransferTransaction1(val *TokenTransferTransaction1) *NullableTokenTransferTransaction1 {
	return &NullableTokenTransferTransaction1{value: val, isSet: true}
}

func (v NullableTokenTransferTransaction1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTokenTransferTransaction1) UnmarshalJSON(src []byte) error {
	v.isSet = true
