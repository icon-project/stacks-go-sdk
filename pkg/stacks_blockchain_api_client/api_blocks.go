...
type ApiGetSignerSignaturesForBlockRequest struct {
	ctx context.Context
	ApiService *BlocksAPIService
	heightOrHash GetBlockHeightOrHashParameter
	limit *int32
...
// Results per page
func (r ApiGetSignerSignaturesForBlockRequest) Limit(limit int32) ApiGetSignerSignaturesForBlockRequest {
	r.limit = &limit
	return r
}

// Result offset
func (r ApiGetSignerSignaturesForBlockRequest) Offset(offset int32) ApiGetSignerSignaturesForBlockRequest {
	r.offset = &offset
	return r
}

func (r ApiGetSignerSignaturesForBlockRequest) Execute() (*GetSignerSignaturesForBlock200Response, *http.Response, error) {
	return r.ApiService.GetSignerSignaturesForBlockExecute(r)
}
...
Retrieves the signer signatures (an array of signature byte strings) in a single block
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param heightOrHash
 @return ApiGetSignerSignaturesForBlockRequest
*/
func (a *BlocksAPIService) GetSignerSignaturesForBlock(ctx context.Context, heightOrHash GetBlockHeightOrHashParameter) ApiGetSignerSignaturesForBlockRequest {
	return ApiGetSignerSignaturesForBlockRequest{
		ApiService: a,
		ctx: ctx,
		heightOrHash: heightOrHash,
...
// Execute executes the request
//  @return GetSignerSignaturesForBlock200Response
func (a *BlocksAPIService) GetSignerSignaturesForBlockExecute(r ApiGetSignerSignaturesForBlockRequest) (*GetSignerSignaturesForBlock200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetSignerSignaturesForBlock200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BlocksAPIService.GetSignerSignaturesForBlock")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/extended/v2/blocks/{height_or_hash}/signer-signatures"
	localVarPath = strings.Replace(localVarPath, "{"+"height_or_hash"+"}", url.PathEscape(parameterValueToString(r.heightOrHash, "heightOrHash")), -1)
