...
// checks if the TenureChangeMempoolTransaction1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenureChangeMempoolTransaction1{}

// TenureChangeMempoolTransaction1 struct for TenureChangeMempoolTransaction1
type TenureChangeMempoolTransaction1 struct {
	// Transaction ID
...
type _TenureChangeMempoolTransaction1 TenureChangeMempoolTransaction1
...
func NewTenureChangeMempoolTransaction1(txId string, nonce int32, feeRate string, senderAddress string, sponsored bool, postConditionMode TokenTransferTransactionPostConditionMode, postConditions []TokenTransferTransactionPostConditionsInner, anchorMode TokenTransferTransactionAnchorMode, txStatus TokenTransferMempoolTransaction1TxStatus, receiptTime int32, receiptTimeIso string, txType string, tenureChangePayload TenureChangeTransactionTenureChangePayload) *TenureChangeMempoolTransaction1 {
	this := TenureChangeMempoolTransaction1{}
	this.TxId = txId
	this.Nonce = nonce
...
func (o TenureChangeMempoolTransaction1) MarshalJSON() ([]byte, error) {
...
func (o TenureChangeMempoolTransaction1) ToMap() (map[string]interface{}, error) {
...
func (o *TenureChangeMempoolTransaction1) UnmarshalJSON(data []byte) (err error) {
	...
	varTenureChangeMempoolTransaction1 := _TenureChangeMempoolTransaction1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTenureChangeMempoolTransaction1)

	if err != nil {
		return err
	}

	*o = TenureChangeMempoolTransaction1(varTenureChangeMempoolTransaction1)

	return err
}

type NullableTenureChangeMempoolTransaction1 struct {
	value *TenureChangeMempoolTransaction1
	isSet bool
}

func (v NullableTenureChangeMempoolTransaction1) Get() *TenureChangeMempoolTransaction1 {
	return v.value
}

func (v *NullableTenureChangeMempoolTransaction1) Set(val *TenureChangeMempoolTransaction1) {
	v.value = val
	v.isSet = true
}

func (v NullableTenureChangeMempoolTransaction1) IsSet() bool {
	return v.isSet
}

func (v *NullableTenureChangeMempoolTransaction1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenureChangeMempoolTransaction1(val *TenureChangeMempoolTransaction1) *NullableTenureChangeMempoolTransaction1 {
	return &NullableTenureChangeMempoolTransaction1{value: val, isSet: true}
}

func (v NullableTenureChangeMempoolTransaction1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenureChangeMempoolTransaction1) UnmarshalJSON(src []byte) error {
	v.isSet = true
