...
func (r ApiGetPoxCycleRequest) Execute() (*GetPoxCycles200ResponseResultsInner, *http.Response, error) {
...
//  @return GetPoxCycles200ResponseResultsInner
func (a *ProofOfTransferAPIService) GetPoxCycleExecute(r ApiGetPoxCycleRequest) (*GetPoxCycles200ResponseResultsInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetPoxCycles200ResponseResultsInner
	)
...
func (r ApiGetPoxCycleSignerRequest) Execute() (*GetPoxCycleSigners200ResponseResultsInner, *http.Response, error) {
...
// Execute executes the request
//  @return GetPoxCycleSigners200ResponseResultsInner
func (a *ProofOfTransferAPIService) GetPoxCycleSignerExecute(r ApiGetPoxCycleSignerRequest) (*GetPoxCycleSigners200ResponseResultsInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetPoxCycleSigners200ResponseResultsInner
	)
...
// Results per page
func (r ApiGetPoxCycleSignerStackersRequest) Limit(limit int32) ApiGetPoxCycleSignerStackersRequest {
	r.limit = &limit
	return r
}

// Result offset
func (r ApiGetPoxCycleSignerStackersRequest) Offset(offset int32) ApiGetPoxCycleSignerStackersRequest {
	r.offset = &offset
	return r
}

func (r ApiGetPoxCycleSignerStackersRequest) Execute() (*GetPoxCycleSignerStackers200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetPoxCycleSignerStackers200Response
func (a *ProofOfTransferAPIService) GetPoxCycleSignerStackersExecute(r ApiGetPoxCycleSignerStackersRequest) (*GetPoxCycleSignerStackers200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetPoxCycleSignerStackers200Response
	)
...
// Results per page
func (r ApiGetPoxCycleSignersRequest) Limit(limit int32) ApiGetPoxCycleSignersRequest {
	r.limit = &limit
	return r
}

// Result offset
func (r ApiGetPoxCycleSignersRequest) Offset(offset int32) ApiGetPoxCycleSignersRequest {
	r.offset = &offset
	return r
}

func (r ApiGetPoxCycleSignersRequest) Execute() (*GetPoxCycleSigners200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetPoxCycleSigners200Response
func (a *ProofOfTransferAPIService) GetPoxCycleSignersExecute(r ApiGetPoxCycleSignersRequest) (*GetPoxCycleSigners200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetPoxCycleSigners200Response
	)
...
func (r ApiGetPoxCyclesRequest) Execute() (*GetPoxCycles200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetPoxCycles200Response
func (a *ProofOfTransferAPIService) GetPoxCyclesExecute(r ApiGetPoxCyclesRequest) (*GetPoxCycles200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetPoxCycles200Response
	)
