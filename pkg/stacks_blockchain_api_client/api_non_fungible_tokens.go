...
func (r ApiGetNftHistoryRequest) Execute() (*GetNftHistory200Response, *http.Response, error) {
...
//  @return GetNftHistory200Response
func (a *NonFungibleTokensAPIService) GetNftHistoryExecute(r ApiGetNftHistoryRequest) (*GetNftHistory200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetNftHistory200Response
	)
	...
	if r.txMetadata == nil {
		return localVarReturnValue, nil, reportError("txMetadata is required and must be specified")
	}

	parameterAddToHeaderOrQuery(localVarQueryParams, "asset_identifier", r.assetIdentifier, "form", "")
	...
	parameterAddToHeaderOrQuery(localVarQueryParams, "tx_metadata", r.txMetadata, "form", "")
...
func (r ApiGetNftHoldingsRequest) Principal(principal GetFilteredEventsAddressParameter) ApiGetNftHoldingsRequest {
...
func (r ApiGetNftHoldingsRequest) Execute() (*GetNftHoldings200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetNftHoldings200Response
func (a *NonFungibleTokensAPIService) GetNftHoldingsExecute(r ApiGetNftHoldingsRequest) (*GetNftHoldings200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetNftHoldings200Response
	)
	...
	if r.assetIdentifiers != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "asset_identifiers", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "asset_identifiers", t, "form", "multi")
		}
	}
	if r.limit != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "limit", r.limit, "form", "")
