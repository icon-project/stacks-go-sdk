...
// checks if the SmartContractTransaction1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SmartContractTransaction1{}

// SmartContractTransaction1 struct for SmartContractTransaction1
type SmartContractTransaction1 struct {
	// Transaction ID
...
type _SmartContractTransaction1 SmartContractTransaction1
...
func NewSmartContractTransaction1(txId string, nonce int32, feeRate string, senderAddress string, sponsored bool, postConditionMode TokenTransferTransaction1PostConditionMode, postConditions []TokenTransferTransaction1PostConditionsInner, anchorMode TokenTransferTransaction1AnchorMode, blockHash string, blockHeight int32, blockTime float32, blockTimeIso string, burnBlockTime int32, burnBlockHeight int32, burnBlockTimeIso string, parentBurnBlockTime int32, parentBurnBlockTimeIso string, canonical bool, txIndex int32, txStatus TokenTransferTransaction1TxStatus, txResult TokenTransferTransactionTxResult, eventCount int32, parentBlockHash string, isUnanchored bool, microblockHash string, microblockSequence int32, microblockCanonical bool, executionCostReadCount int32, executionCostReadLength int32, executionCostRuntime int32, executionCostWriteCount int32, executionCostWriteLength int32, events []TokenTransferTransaction1EventsInner, txType string, smartContract SmartContractTransactionSmartContract) *SmartContractTransaction1 {
	this := SmartContractTransaction1{}
	this.TxId = txId
	this.Nonce = nonce
...
func (o SmartContractTransaction1) MarshalJSON() ([]byte, error) {
...
func (o SmartContractTransaction1) ToMap() (map[string]interface{}, error) {
...
func (o *SmartContractTransaction1) UnmarshalJSON(data []byte) (err error) {
	...
	varSmartContractTransaction1 := _SmartContractTransaction1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSmartContractTransaction1)

	if err != nil {
		return err
	}

	*o = SmartContractTransaction1(varSmartContractTransaction1)

	return err
}

type NullableSmartContractTransaction1 struct {
	value *SmartContractTransaction1
	isSet bool
}

func (v NullableSmartContractTransaction1) Get() *SmartContractTransaction1 {
	return v.value
}

func (v *NullableSmartContractTransaction1) Set(val *SmartContractTransaction1) {
	v.value = val
	v.isSet = true
}

func (v NullableSmartContractTransaction1) IsSet() bool {
	return v.isSet
}

func (v *NullableSmartContractTransaction1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSmartContractTransaction1(val *SmartContractTransaction1) *NullableSmartContractTransaction1 {
	return &NullableSmartContractTransaction1{value: val, isSet: true}
}

func (v NullableSmartContractTransaction1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSmartContractTransaction1) UnmarshalJSON(src []byte) error {
	v.isSet = true
