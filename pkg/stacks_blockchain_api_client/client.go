...
// APIClient manages communication with the Stacks Blockchain API API vv7.14.1
...
type APIClient struct {
	...
	FungibleTokensAPI *FungibleTokensAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.FungibleTokensAPI = (*FungibleTokensAPIService)(&c.common)
...
func parameterValueToString( obj interface{}, key string ) string {
	if param, ok := obj.(GetNetworkBlockTimeByNetworkNetworkParameter); ok {
        if param.String != nil {
            return *param.String
        }
        return ""
    }
	if param, ok := obj.(GetFilteredEventsAddressParameter); ok {
        if param.String != nil {
            return *param.String
        }
        return ""
    }
	if param, ok := obj.(GetBlockHeightOrHashParameter); ok {
		if param.Uint64 != nil {
