...
func (r ApiGetBurnchainRewardListRequest) Execute() (*GetBurnchainRewardList200Response, *http.Response, error) {
...
//  @return GetBurnchainRewardList200Response
func (a *StackingRewardsAPIService) GetBurnchainRewardListExecute(r ApiGetBurnchainRewardListRequest) (*GetBurnchainRewardList200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetBurnchainRewardList200Response
	)
...
func (r ApiGetBurnchainRewardListByAddressRequest) Execute() (*GetBurnchainRewardList200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetBurnchainRewardList200Response
func (a *StackingRewardsAPIService) GetBurnchainRewardListByAddressExecute(r ApiGetBurnchainRewardListByAddressRequest) (*GetBurnchainRewardList200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiGetBurnchainRewardSlotHoldersRequest) Execute() (*ListOfBurnchainRewardRecipientsAndAmounts, *http.Response, error) {
...
// Execute executes the request
//  @return ListOfBurnchainRewardRecipientsAndAmounts
func (a *StackingRewardsAPIService) GetBurnchainRewardSlotHoldersExecute(r ApiGetBurnchainRewardSlotHoldersRequest) (*ListOfBurnchainRewardRecipientsAndAmounts, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListOfBurnchainRewardRecipientsAndAmounts
	)
...
func (r ApiGetBurnchainRewardSlotHoldersByAddressRequest) Execute() (*BurnchainRewardSlotHolderListResponse, *http.Response, error) {
...
func (a *StackingRewardsAPIService) GetBurnchainRewardSlotHoldersByAddressExecute(r ApiGetBurnchainRewardSlotHoldersByAddressRequest) (*BurnchainRewardSlotHolderListResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
