...
// checks if the CoinbaseTransaction1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CoinbaseTransaction1{}

// CoinbaseTransaction1 struct for CoinbaseTransaction1
type CoinbaseTransaction1 struct {
	// Transaction ID
...
type _CoinbaseTransaction1 CoinbaseTransaction1
...
func (o CoinbaseTransaction1) MarshalJSON() ([]byte, error) {
...
func (o CoinbaseTransaction1) ToMap() (map[string]interface{}, error) {
...
func (o *CoinbaseTransaction1) UnmarshalJSON(data []byte) (err error) {
	...
	varCoinbaseTransaction1 := _CoinbaseTransaction1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCoinbaseTransaction1)

	if err != nil {
		return err
	}

	*o = CoinbaseTransaction1(varCoinbaseTransaction1)

	return err
}

type NullableCoinbaseTransaction1 struct {
	value *CoinbaseTransaction1
	isSet bool
}

func (v NullableCoinbaseTransaction1) Get() *CoinbaseTransaction1 {
	return v.value
}

func (v *NullableCoinbaseTransaction1) Set(val *CoinbaseTransaction1) {
	v.value = val
	v.isSet = true
}

func (v NullableCoinbaseTransaction1) IsSet() bool {
	return v.isSet
}

func (v *NullableCoinbaseTransaction1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoinbaseTransaction1(val *CoinbaseTransaction1) *NullableCoinbaseTransaction1 {
	return &NullableCoinbaseTransaction1{value: val, isSet: true}
}

func (v NullableCoinbaseTransaction1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoinbaseTransaction1) UnmarshalJSON(src []byte) error {
	v.isSet = true
