...
// checks if the TenureChangeTransaction1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenureChangeTransaction1{}

// TenureChangeTransaction1 struct for TenureChangeTransaction1
type TenureChangeTransaction1 struct {
	// Transaction ID
...
type _TenureChangeTransaction1 TenureChangeTransaction1
...
func (o TenureChangeTransaction1) MarshalJSON() ([]byte, error) {
...
func (o TenureChangeTransaction1) ToMap() (map[string]interface{}, error) {
...
func (o *TenureChangeTransaction1) UnmarshalJSON(data []byte) (err error) {
	...
	varTenureChangeTransaction1 := _TenureChangeTransaction1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTenureChangeTransaction1)

	if err != nil {
		return err
	}

	*o = TenureChangeTransaction1(varTenureChangeTransaction1)

	return err
}

type NullableTenureChangeTransaction1 struct {
	value *TenureChangeTransaction1
	isSet bool
}

func (v NullableTenureChangeTransaction1) Get() *TenureChangeTransaction1 {
	return v.value
}

func (v *NullableTenureChangeTransaction1) Set(val *TenureChangeTransaction1) {
	v.value = val
	v.isSet = true
}

func (v NullableTenureChangeTransaction1) IsSet() bool {
	return v.isSet
}

func (v *NullableTenureChangeTransaction1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenureChangeTransaction1(val *TenureChangeTransaction1) *NullableTenureChangeTransaction1 {
	return &NullableTenureChangeTransaction1{value: val, isSet: true}
}

func (v NullableTenureChangeTransaction1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenureChangeTransaction1) UnmarshalJSON(src []byte) error {
	v.isSet = true
