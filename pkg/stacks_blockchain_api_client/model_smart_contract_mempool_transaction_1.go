...
// checks if the SmartContractMempoolTransaction1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SmartContractMempoolTransaction1{}

// SmartContractMempoolTransaction1 struct for SmartContractMempoolTransaction1
type SmartContractMempoolTransaction1 struct {
	// Transaction ID
...
type _SmartContractMempoolTransaction1 SmartContractMempoolTransaction1
...
func NewSmartContractMempoolTransaction1(txId string, nonce int32, feeRate string, senderAddress string, sponsored bool, postConditionMode TokenTransferTransactionPostConditionMode, postConditions []TokenTransferTransactionPostConditionsInner, anchorMode TokenTransferTransactionAnchorMode, txStatus TokenTransferMempoolTransaction1TxStatus, receiptTime int32, receiptTimeIso string, txType string, smartContract SmartContractTransactionSmartContract) *SmartContractMempoolTransaction1 {
	this := SmartContractMempoolTransaction1{}
	this.TxId = txId
	this.Nonce = nonce
...
func (o SmartContractMempoolTransaction1) MarshalJSON() ([]byte, error) {
...
func (o SmartContractMempoolTransaction1) ToMap() (map[string]interface{}, error) {
...
func (o *SmartContractMempoolTransaction1) UnmarshalJSON(data []byte) (err error) {
	...
	varSmartContractMempoolTransaction1 := _SmartContractMempoolTransaction1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSmartContractMempoolTransaction1)

	if err != nil {
		return err
	}

	*o = SmartContractMempoolTransaction1(varSmartContractMempoolTransaction1)

	return err
}

type NullableSmartContractMempoolTransaction1 struct {
	value *SmartContractMempoolTransaction1
	isSet bool
}

func (v NullableSmartContractMempoolTransaction1) Get() *SmartContractMempoolTransaction1 {
	return v.value
}

func (v *NullableSmartContractMempoolTransaction1) Set(val *SmartContractMempoolTransaction1) {
	v.value = val
	v.isSet = true
}

func (v NullableSmartContractMempoolTransaction1) IsSet() bool {
	return v.isSet
}

func (v *NullableSmartContractMempoolTransaction1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSmartContractMempoolTransaction1(val *SmartContractMempoolTransaction1) *NullableSmartContractMempoolTransaction1 {
	return &NullableSmartContractMempoolTransaction1{value: val, isSet: true}
}

func (v NullableSmartContractMempoolTransaction1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSmartContractMempoolTransaction1) UnmarshalJSON(src []byte) error {
	v.isSet = true
