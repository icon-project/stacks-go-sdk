...
func (r ApiGetFeeTransferRequest) Execute() (string, *http.Response, error) {
...
type ApiPostFeeTransactionRequest struct {
	ctx context.Context
	ApiService *FeesAPIService
	postFeeTransactionschema *PostFeeTransactionschema
}
...
func (r ApiPostFeeTransactionRequest) PostFeeTransactionschema(postFeeTransactionschema PostFeeTransactionschema) ApiPostFeeTransactionRequest {
	r.postFeeTransactionschema = &postFeeTransactionschema
	return r
}

func (r ApiPostFeeTransactionRequest) Execute() (*PostFeeTransactionResponseschema, *http.Response, error) {
...
func (a *FeesAPIService) PostFeeTransactionExecute(r ApiPostFeeTransactionRequest) (*PostFeeTransactionResponseschema, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PostFeeTransactionResponseschema
	)
	...
	// body params
	localVarPostBody = r.postFeeTransactionschema
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
